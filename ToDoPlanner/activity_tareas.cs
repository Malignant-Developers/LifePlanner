...
{
    [Activity(Label = "activity_tareas")]
    public class activity_tareas : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_tareas);
            ...
            Button borrarTarea = FindViewById<Button>(Resource.Id.btn_borrarTarea);
